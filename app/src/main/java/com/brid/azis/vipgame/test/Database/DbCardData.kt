...
private val TABLE_NAME = "DbCardData"


class DbCardData (var context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
...
//            Toast.makeText(context, "Data Sukses Dimasukkan", Toast.LENGTH_SHORT).show()
    ...
    fun copyOneData (card: Card? ,tableFrom:String?, tableInto:String?){
        val queryCopy = "INSERT INTO " + tableInto + "SELECT * FROM" + tableFrom
        val result = ""
        TODO("Buat fungsi untuk menyalin data")
